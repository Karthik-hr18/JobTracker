...
function UpdateJob() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await api.put(`/jobs/update/${id}`, formData);
  ...
  if (dataLoading) return <div className="p-8 text-center text-gray-500 font-medium flex items-center justify-center gap-2"><Loader2 className="animate-spin" size={18}/> Loading application details...</div>;
  ...
  return (
    <div className="w-full max-w-3xl mx-auto pb-12">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 mb-2">Update Application</h1>
        <p className="text-gray-500 text-[15px]">Modify the details of your tracked job application.</p>
      </div>
